    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#" data-target="#signin" data-toggle="modal">Sign in</a></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body padtrbl">
          ...
          <div class="login-box-body">
            <p class="login-box-msg">Sign in to get yourself registered</p>
            <div class="form-group">
              <form action="registration.php" method="post" id="loginForm">
                <div class="form-group has-feedback">
                  <!----- username -------------->
                  <input class="form-control" name="user" placeholder="Username" id="loginid" type="text" autocomplete="off" />
  ...
  <div class="modal fade" id="login" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title text-center form-title">Log In</h4>
        </div>
        <div class="modal-body padtrbl">
        ...
        <div class="row">
          <div class="banner-text text-center">
            ...
            <div class="intro-para text-center quote">
              ...
              <a href="#footer" class="btn get-quote"><h5 style="color: white;">APPLY</h5></a>
            </div>
